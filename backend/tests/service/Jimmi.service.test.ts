import { createJimmi, getAllJimmiIds, getJimmiBy, initializeBrowser, args } from '../../src/service/Jimmi.service.ts';
...
Deno.test('Jimmi service browser initialization', async () => {
  ...
  await assertRejects(async () => {await initializeBrowser(config, {} as unknown as typeof puppeteer)})
});
