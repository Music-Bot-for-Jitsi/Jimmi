...
Deno.test('POST /api/instances/unknown-id/ that it returns 404!', async () => {
  await superdeno(app)
...
Deno.test('POST /api/instances/known-id/music/ that it returns 200 for actions PLAY, PAUSE and STOP and 400 for an unknown or missing ACTION', async () => {
